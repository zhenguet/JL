...
export default function UsagePageClient({ lessonNumber }: UsagePageClientProps) {
  const { t } = useI18n()
  ...
  if (wordsWithExplanation.length === 0) {
    return (
      <div className="usage-container">
        ...
        <EmptyMessage message={`${t.usage.noData} ${lessonNumber}`} />
      </div>
    )
  }
  ...
  return (
    <div className="usage-container">
      <PageTitle title={t.usage.title} lessonNumber={lessonNumber} />
      <p className="intro-text">{t.usage.intro}</p>
